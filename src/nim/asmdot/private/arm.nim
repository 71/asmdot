...
proc cmn*(buf: var pointer, cond: Condition, rn: Reg) = 
  var
    cond = uint8 cond
    rn = uint8 rn
...
proc cmp*(buf: var pointer, cond: Condition, rn: Reg) = 
  var
    cond = uint8 cond
    rn = uint8 rn
...
proc cdp*(buf: var pointer, cond: Condition, cpnum: Coprocessor) = 
  var
    cond = uint8 cond
    cpnum = uint8 cpnum
...
proc mcr*(buf: var pointer, cond: Condition, rd: Reg, cpnum: Coprocessor) = 
  var
    cond = uint8 cond
    rd = uint8 rd
    cpnum = uint8 cpnum
...
proc mrc*(buf: var pointer, cond: Condition, rd: Reg, cpnum: Coprocessor) = 
  var
    cond = uint8 cond
    rd = uint8 rd
    cpnum = uint8 cpnum
...
proc mcrr*(buf: var pointer, cond: Condition, rn: Reg, rd: Reg, cpnum: Coprocessor) = 
  var
    cond = uint8 cond
    rn = uint8 rn
    rd = uint8 rd
...
proc mrrc*(buf: var pointer, cond: Condition, rn: Reg, rd: Reg, cpnum: Coprocessor) = 
  var
    cond = uint8 cond
    rn = uint8 rn
    rd = uint8 rd
...
proc smlad*(buf: var pointer, cond: Condition, exchange: bool, rn: Reg, rd: Reg) = 
  var
    cond = uint8 cond
    rn = uint8 rn
    rd = uint8 rd
...
proc smlald*(buf: var pointer, cond: Condition, exchange: bool) = 
  var
    cond = uint8 cond
...
proc smlsd*(buf: var pointer, cond: Condition, exchange: bool, rn: Reg, rd: Reg) = 
  var
    cond = uint8 cond
    rn = uint8 rn
    rd = uint8 rd
...
proc smlsld*(buf: var pointer, cond: Condition, exchange: bool) = 
  var
    cond = uint8 cond
...
proc smuad*(buf: var pointer, cond: Condition, exchange: bool, rd: Reg) = 
  var
    cond = uint8 cond
    rd = uint8 rd
...
proc smusd*(buf: var pointer, cond: Condition, exchange: bool, rd: Reg) = 
  var
    cond = uint8 cond
    rd = uint8 rd
...
proc teq*(buf: var pointer, cond: Condition, rn: Reg) = 
  var
    cond = uint8 cond
    rn = uint8 rn
...
proc tst*(buf: var pointer, cond: Condition, rn: Reg) = 
  var
    cond = uint8 cond
    rn = uint8 rn
