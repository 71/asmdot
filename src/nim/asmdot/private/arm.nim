proc adc*(buf: var pointer, cond: Condition, i: bool, s: bool, rn: Reg, rd: Reg) =
  ...
  cast[ptr int32](buf)[] = (((((1280'u32 or cond) or (i shl 6'u8)) or (s shl 11'u8)) or (rn shl 12'u32)) or (rd shl 16'u32))
...
proc add*(buf: var pointer, cond: Condition, i: bool, s: bool, rn: Reg, rd: Reg) =
  ...
  cast[ptr int32](buf)[] = (((((256'u32 or cond) or (i shl 6'u8)) or (s shl 11'u8)) or (rn shl 12'u32)) or (rd shl 16'u32))
  buf = cast[pointer](cast[uint](buf) + 4)
...
proc and*(buf: var pointer, cond: Condition, i: bool, s: bool, rn: Reg, rd: Reg) =
  ...
  cast[ptr int32](buf)[] = (((((0'u32 or cond) or (i shl 6'u8)) or (s shl 11'u8)) or (rn shl 12'u32)) or (rd shl 16'u32))
  buf = cast[pointer](cast[uint](buf) + 4)
...
proc eor*(buf: var pointer, cond: Condition, i: bool, s: bool, rn: Reg, rd: Reg) =
  ...
  cast[ptr int32](buf)[] = (((((1024'u32 or cond) or (i shl 6'u8)) or (s shl 11'u8)) or (rn shl 12'u32)) or (rd shl 16'u32))
  buf = cast[pointer](cast[uint](buf) + 4)
...
proc orr*(buf: var pointer, cond: Condition, i: bool, s: bool, rn: Reg, rd: Reg) =
  ...
  cast[ptr int32](buf)[] = (((((384'u32 or cond) or (i shl 6'u8)) or (s shl 11'u8)) or (rn shl 12'u32)) or (rd shl 16'u32))
  buf = cast[pointer](cast[uint](buf) + 4)
...
proc rsb*(buf: var pointer, cond: Condition, i: bool, s: bool, rn: Reg, rd: Reg) =
  ...
  cast[ptr int32](buf)[] = (((((1536'u32 or cond) or (i shl 6'u8)) or (s shl 11'u8)) or (rn shl 12'u32)) or (rd shl 16'u32))
  buf = cast[pointer](cast[uint](buf) + 4)
...
proc rsc*(buf: var pointer, cond: Condition, i: bool, s: bool, rn: Reg, rd: Reg) =
  ...
  cast[ptr int32](buf)[] = (((((1792'u32 or cond) or (i shl 6'u8)) or (s shl 11'u8)) or (rn shl 12'u32)) or (rd shl 16'u32))
  buf = cast[pointer](cast[uint](buf) + 4)
...
proc sbc*(buf: var pointer, cond: Condition, i: bool, s: bool, rn: Reg, rd: Reg) =
  ...
  cast[ptr int32](buf)[] = (((((768'u32 or cond) or (i shl 6'u8)) or (s shl 11'u8)) or (rn shl 12'u32)) or (rd shl 16'u32))
  buf = cast[pointer](cast[uint](buf) + 4)
...
proc sub*(buf: var pointer, cond: Condition, i: bool, s: bool, rn: Reg, rd: Reg) =
  ...
  cast[ptr int32](buf)[] = (((((512'u32 or cond) or (i shl 6'u8)) or (s shl 11'u8)) or (rn shl 12'u32)) or (rd shl 16'u32))
  buf = cast[pointer](cast[uint](buf) + 4)
...
proc bic*(buf: var pointer, cond: Condition, i: bool, s: bool, rn: Reg, rd: Reg) =
  ...
  cast[ptr int32](buf)[] = (((((896'u32 or cond) or (i shl 6'u8)) or (s shl 11'u8)) or (rn shl 12'u32)) or (rd shl 16'u32))
  buf = cast[pointer](cast[uint](buf) + 4)
...
proc cmn*(buf: var pointer, cond: Condition, i: bool, rn: Reg) =
  ...
  cast[ptr int32](buf)[] = (((3712'u32 or cond) or (i shl 6'u8)) or (rn shl 12'u32))
  buf = cast[pointer](cast[uint](buf) + 4)
...
proc cmp*(buf: var pointer, cond: Condition, i: bool, rn: Reg) =
  ...
  cast[ptr int32](buf)[] = (((2688'u32 or cond) or (i shl 6'u8)) or (rn shl 12'u32))
  buf = cast[pointer](cast[uint](buf) + 4)
...
proc ldc*(buf: var pointer, cond: Condition, write: bool, rn: Reg) =
  ...
  cast[ptr int32](buf)[] = (((560'u32 or cond) or (write shl 8'u8)) or (rn shl 10'u32))
  buf = cast[pointer](cast[uint](buf) + 4)
...
proc ldm1*(buf: var pointer, cond: Condition, write: bool, rn: Reg) =
  ...
  cast[ptr int32](buf)[] = (((528'u32 or cond) or (write shl 8'u8)) or (rn shl 10'u32))
  buf = cast[pointer](cast[uint](buf) + 4)
...
proc ldm3*(buf: var pointer, cond: Condition, write: bool, rn: Reg) =
  ...
  cast[ptr int32](buf)[] = (((17040'u32 or cond) or (write shl 8'u8)) or (rn shl 10'u32))
  buf = cast[pointer](cast[uint](buf) + 4)
...
proc ldr*(buf: var pointer, cond: Condition, write: bool, i: bool, rn: Reg, rd: Reg) =
  ...
  cast[ptr int32](buf)[] = (((((544'u32 or cond) or (write shl 8'u8)) or (i shl 6'u8)) or (rn shl 10'u32)) or (rd shl 14'u32))
  buf = cast[pointer](cast[uint](buf) + 4)
...
proc ldrb*(buf: var pointer, cond: Condition, write: bool, i: bool, rn: Reg, rd: Reg) =
  ...
  cast[ptr int32](buf)[] = (((((672'u32 or cond) or (write shl 8'u8)) or (i shl 6'u8)) or (rn shl 10'u32)) or (rd shl 14'u32))
  buf = cast[pointer](cast[uint](buf) + 4)
...
proc ldrbt*(buf: var pointer, cond: Condition, i: bool, rn: Reg, rd: Reg) =
  ...
  cast[ptr int32](buf)[] = ((((1824'u32 or cond) or (i shl 6'u8)) or (rn shl 11'u32)) or (rd shl 15'u32))
  buf = cast[pointer](cast[uint](buf) + 4)
...
proc ldrd*(buf: var pointer, cond: Condition, write: bool, i: bool, rn: Reg, rd: Reg) =
  ...
  cast[ptr int32](buf)[] = (((((2883584'u32 or cond) or (write shl 8'u8)) or (i shl 7'u8)) or (rn shl 10'u32)) or (rd shl 14'u32))
  buf = cast[pointer](cast[uint](buf) + 4)
...
proc ldrh*(buf: var pointer, cond: Condition, write: bool, i: bool, rn: Reg, rd: Reg) =
  ...
  cast[ptr int32](buf)[] = (((((3408384'u32 or cond) or (write shl 8'u8)) or (i shl 7'u8)) or (rn shl 10'u32)) or (rd shl 14'u32))
  buf = cast[pointer](cast[uint](buf) + 4)
...
proc ldrsb*(buf: var pointer, cond: Condition, write: bool, i: bool, rn: Reg, rd: Reg) =
  ...
  cast[ptr int32](buf)[] = (((((2884096'u32 or cond) or (write shl 8'u8)) or (i shl 7'u8)) or (rn shl 10'u32)) or (rd shl 14'u32))
  buf = cast[pointer](cast[uint](buf) + 4)
...
proc ldrsh*(buf: var pointer, cond: Condition, write: bool, i: bool, rn: Reg, rd: Reg) =
  ...
  cast[ptr int32](buf)[] = (((((3932672'u32 or cond) or (write shl 8'u8)) or (i shl 7'u8)) or (rn shl 10'u32)) or (rd shl 14'u32))
  buf = cast[pointer](cast[uint](buf) + 4)
...
proc ldrt*(buf: var pointer, cond: Condition, i: bool, rn: Reg, rd: Reg) =
  ...
  cast[ptr int32](buf)[] = ((((1568'u32 or cond) or (i shl 6'u8)) or (rn shl 11'u32)) or (rd shl 15'u32))
  buf = cast[pointer](cast[uint](buf) + 4)
...
proc mla*(buf: var pointer, cond: Condition, s: bool, rn: Reg, rd: Reg) =
  ...
  cast[ptr int32](buf)[] = ((((150995968'u32 or cond) or (s shl 11'u8)) or (rn shl 16'u32)) or (rd shl 12'u32))
  buf = cast[pointer](cast[uint](buf) + 4)
...
proc mov*(buf: var pointer, cond: Condition, i: bool, s: bool, rd: Reg) =
  ...
  cast[ptr int32](buf)[] = ((((1408'u32 or cond) or (i shl 6'u8)) or (s shl 11'u8)) or (rd shl 16'u32))
  buf = cast[pointer](cast[uint](buf) + 4)
...
proc mul*(buf: var pointer, cond: Condition, s: bool, rd: Reg) =
  ...
  cast[ptr int32](buf)[] = (((150994944'u32 or cond) or (s shl 11'u8)) or (rd shl 12'u32))
  buf = cast[pointer](cast[uint](buf) + 4)
...
proc mvn*(buf: var pointer, cond: Condition, i: bool, s: bool, rd: Reg) =
  ...
  cast[ptr int32](buf)[] = ((((1920'u32 or cond) or (i shl 6'u8)) or (s shl 11'u8)) or (rd shl 16'u32))
  buf = cast[pointer](cast[uint](buf) + 4)
...
proc pld*(buf: var pointer, i: bool, rn: Reg) =
  ...
  cast[ptr int32](buf)[] = ((492975'u32 or (i shl 6'u8)) or (rn shl 11'u32))
  buf = cast[pointer](cast[uint](buf) + 4)
...
proc rfe*(buf: var pointer, write: bool, rn: Reg) =
  ...
  cast[ptr int32](buf)[] = ((1311263'u32 or (write shl 8'u8)) or (rn shl 10'u32))
  buf = cast[pointer](cast[uint](buf) + 4)
...
proc smlal*(buf: var pointer, cond: Condition, s: bool) =
  ...
  cast[ptr int32](buf)[] = ((150996736'u32 or cond) or (s shl 11'u8))
  buf = cast[pointer](cast[uint](buf) + 4)
...
proc smull*(buf: var pointer, cond: Condition, s: bool) =
  ...
  cast[ptr int32](buf)[] = ((301991424'u32 or cond) or (s shl 12'u8))
  buf = cast[pointer](cast[uint](buf) + 4)
...
proc srs*(buf: var pointer, write: bool, mode: Mode) =
  ...
  cast[ptr int32](buf)[] = ((2632863'u32 or (write shl 8'u8)) or (mode shl 26'u32))
  buf = cast[pointer](cast[uint](buf) + 4)
...
proc stc*(buf: var pointer, cond: Condition, write: bool, rn: Reg) =
  ...
  cast[ptr int32](buf)[] = (((48'u32 or cond) or (write shl 8'u8)) or (rn shl 10'u32))
  buf = cast[pointer](cast[uint](buf) + 4)
...
proc stm1*(buf: var pointer, cond: Condition, write: bool, rn: Reg) =
  ...
  cast[ptr int32](buf)[] = (((16'u32 or cond) or (write shl 8'u8)) or (rn shl 10'u32))
  buf = cast[pointer](cast[uint](buf) + 4)
...
proc str*(buf: var pointer, cond: Condition, write: bool, i: bool, rn: Reg, rd: Reg) =
  ...
  cast[ptr int32](buf)[] = (((((32'u32 or cond) or (write shl 8'u8)) or (i shl 6'u8)) or (rn shl 10'u32)) or (rd shl 14'u32))
  buf = cast[pointer](cast[uint](buf) + 4)
...
proc strb*(buf: var pointer, cond: Condition, write: bool, i: bool, rn: Reg, rd: Reg) =
  ...
  cast[ptr int32](buf)[] = (((((160'u32 or cond) or (write shl 8'u8)) or (i shl 6'u8)) or (rn shl 10'u32)) or (rd shl 14'u32))
  buf = cast[pointer](cast[uint](buf) + 4)
...
proc strbt*(buf: var pointer, cond: Condition, i: bool, rn: Reg, rd: Reg) =
  ...
  cast[ptr int32](buf)[] = ((((800'u32 or cond) or (i shl 6'u8)) or (rn shl 11'u32)) or (rd shl 15'u32))
  buf = cast[pointer](cast[uint](buf) + 4)
...
proc strd*(buf: var pointer, cond: Condition, write: bool, i: bool, rn: Reg, rd: Reg) =
  ...
  cast[ptr int32](buf)[] = (((((3932160'u32 or cond) or (write shl 8'u8)) or (i shl 7'u8)) or (rn shl 10'u32)) or (rd shl 14'u32))
  buf = cast[pointer](cast[uint](buf) + 4)
...
proc strh*(buf: var pointer, cond: Condition, write: bool, i: bool, rn: Reg, rd: Reg) =
  ...
  cast[ptr int32](buf)[] = (((((3407872'u32 or cond) or (write shl 8'u8)) or (i shl 7'u8)) or (rn shl 10'u32)) or (rd shl 14'u32))
  buf = cast[pointer](cast[uint](buf) + 4)
...
proc strt*(buf: var pointer, cond: Condition, i: bool, rn: Reg, rd: Reg) =
  ...
  cast[ptr int32](buf)[] = ((((544'u32 or cond) or (i shl 6'u8)) or (rn shl 11'u32)) or (rd shl 15'u32))
  buf = cast[pointer](cast[uint](buf) + 4)
...
proc teq*(buf: var pointer, cond: Condition, i: bool, rn: Reg) =
  ...
  cast[ptr int32](buf)[] = (((3200'u32 or cond) or (i shl 6'u8)) or (rn shl 12'u32))
  buf = cast[pointer](cast[uint](buf) + 4)
...
proc tst*(buf: var pointer, cond: Condition, i: bool, rn: Reg) =
  ...
  cast[ptr int32](buf)[] = (((2176'u32 or cond) or (i shl 6'u8)) or (rn shl 12'u32))
  buf = cast[pointer](cast[uint](buf) + 4)
...
proc umlal*(buf: var pointer, cond: Condition, s: bool) =
  ...
  cast[ptr int32](buf)[] = ((150996224'u32 or cond) or (s shl 11'u8))
  buf = cast[pointer](cast[uint](buf) + 4)
...
proc umull*(buf: var pointer, cond: Condition, s: bool) =
  ...
  cast[ptr int32](buf)[] = ((150995200'u32 or cond) or (s shl 11'u8))
  buf = cast[pointer](cast[uint](buf) + 4)
