...
namespace AsmSq
{
    public static class X86
    {
        ...
        [DllImport("asmsq", EntryPoint = "inc_r16_r32", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("asmsq", EntryPoint = "dec_r16_r32", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("asmsq", EntryPoint = "push_r16_r32", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("asmsq", EntryPoint = "pop_r16_r32", CallingConvention = CallingConvention.Cdecl)]
        public static int pop(Register32 operand, ref IntPtr buf);
        [DllImport("asmsq", EntryPoint = "pop_r16_r32_r64", CallingConvention = CallingConvention.Cdecl)]
